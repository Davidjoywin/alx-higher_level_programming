...
"""
Creating a class base of all other class in this project
"""
import json
...
class Base:
    """
        This class will be the manage other class of the other
    ...
    def to_json_string(list_dictionaries):
        """
            Returns the json format of list dictionaries
        """
    ...
    def save_to_file(cls, list_objs):
        ...
        if list_objs:
            for objs in list_objs:
                objs = objs.to_dictionary()
                json_objs = json.loads(cls.to_json_string(objs))
                content.append(json_objs)
